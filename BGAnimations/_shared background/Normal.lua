...
local t = Def.ActorFrame {
	InitCommand=function(self)
		...
		self:visible(not ThemePrefs.Get("RainbowMode") and style ~= "SRPG7" and style ~= "Technique" and style ~= "Hate")
	end,
	...
	VisualStyleSelectedMessageCommand=function(self)
		...
		if ThemePrefs.Get("RainbowMode") or style == "SRPG7" or style == "Technique" or style ==  "Hate" then
